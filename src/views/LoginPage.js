          ...
          >
            ...
            >
              <Box sx={{ padding: "10px", marginTop: "25px" }}>
                <Typography align="left" variant="h4" sx={{ color: "white" }}>
                  <b>
                    {" "}
                    Welcome <br /> Back
                  </b>
              ...
              >
                <Typography align="left" variant="h6" sx={{ color: "white" }}>
            ...
            >
              ...
              <p>
                ...
                <Button onClick={toggleForm} sx={{ color: "orange" }}>
                  Sign up
                </Button>
              </p>
            </Box>
