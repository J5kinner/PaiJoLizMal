    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      >
        <Toolbar sx={{ color: "#000" }}>
          ...
          >
            <Typography variant="title" color={Colours.teal}>
              Pai
            </Typography>
            <Typography variant="title" color={Colours.mustard}>
              jo
            </Typography>
            <Typography variant="title" color={Colours.carrot}>
              liz
            </Typography>
            <Typography variant="title" color={Colours.rust}>
              mal
            </Typography>
          </Link>
        ...
        <Collapse in={isMenuOpen} sx={{ display: { xs: "block", sm: "none" } }}>
          {renderMenu}
        </Collapse>
      </AppBar>
    </Box>
