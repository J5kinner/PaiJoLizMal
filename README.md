...
Prolonged focused work is hard to achieve with the ever present distractions of today's technologies. As such it is more important than ever for students, researchers, and learners of all fields and disciplines to manage their focus.
...
* `HomePage.js`: Renders the home page with the list of `RANTS`.
